...
export const OFFERS_TEXT = {
  en: {
    ...
    previewHint: 'Pick an offer above to preview exactly what the customer will receive',
    previewLoading: 'Loading preview…',
    previewUnavailable: "Couldn't load the preview — the message will still send as usual.",
    previewStatusApproved: 'Approved by Meta',
  ...
  ta: {
    ...
    previewTitle: 'செய்தி முன்னோட்டம்',
    previewHint: 'வாடிக்கையாளர் பெறும் செய்தியை முன்னோட்டமாகக் காண மேலே ஒரு சலுகையைத் தேர்ந்தெடுக்கவும்',
    previewLoading: 'முன்னோட்டம் ஏற்றப்படுகிறது…',
    previewUnavailable: 'முன்னோட்டத்தை ஏற்ற முடியவில்லை — செய்தி வழக்கம் போல் அனுப்பப்படும்.',
    previewStatusApproved: 'Meta ஆல் அங்கீகரிக்கப்பட்டது',
